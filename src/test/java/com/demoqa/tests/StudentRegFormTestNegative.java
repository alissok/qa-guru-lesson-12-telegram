...
public class StudentRegFormTestNegative extends TestSetupAndTeardown {
    ...
    @Test
    @Tag("demoqa_reg")
    @DisplayName("Fill Registration Form With Random Data And Check Cached Data")
    void fillRegForm() {
        ...
        step("Check Filled Registration Form", () -> {
            ...
            $(".practice-form-wrapper").shouldHave(//Check if form cached personal data
                    text(firstName),
                    text(lastName),
                    text(userEmail),
                    text(currAddress)
